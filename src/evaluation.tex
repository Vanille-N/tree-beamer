...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item elimination of out-of-bounds UB\\
            \(\qquad\Rightarrow\) frequent blocker in SB for many popular crates
...
\begin{frame}
    ...
    Don't hesitate to test your code with Miri and send us your interesting cases of UB!\\
    Slides for this presentation on \href{https://github.com/Vanille-N/tree-beamer}{\texttt{github:Vanille-N/tree-beamer}}\\
