...
\begin{frame}[fragile, t]
    ...
    \begin{onlyenv}<2>
        ...
        \begin{align*}
            ...
            & \wedge \forall (\_, p', \_) \in \textsf{Children}_{\sigma_t, l}(t) . p' = \textsf{Disabled} \\
            & \wedge \forall (\_, p', \_) \in \textsf{Parents}_{\sigma_t, l}(t) . p' = \textsf{Active} \\
            & \wedge \forall (\_, p', \_) \in \textsf{Uncles}_{\sigma_t, l}(t) . p' \in \{\textsf{Disabled, Res InMut}\}
        \end{align*}
